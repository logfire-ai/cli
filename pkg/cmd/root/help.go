...
func authHelp() string {
	return heredoc.Doc(`
		To get started with Logfire CLI, please run:  logfire login
		Alternatively, if you don't have an account, to create a new account, please run: logfire signup.
	`)
}
...
func rootHelpFunc(f *cmdutil.Factory, command *cobra.Command, args []string) {
	...
	helpEntries = append(helpEntries, helpEntry{"LEARN MORE",
		`Use 'logfire <command> <subcommand> --help' for more information about a command.`})
